...
class EncuestaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encuestum" do
    assert_difference('Encuestum.count') do
      post encuesta_url, params: { encuestum: { fecha_creacion_encuesta: @encuestum.fecha_creacion_encuesta, id_encuesta: @encuestum.id_encuesta, motivo_encuesta: @encuestum.motivo_encuesta, resuelto_encuesta: @encuestum.resuelto_encuesta } }
    end
  ...
  test "should update encuestum" do
    patch encuestum_url(@encuestum), params: { encuestum: { fecha_creacion_encuesta: @encuestum.fecha_creacion_encuesta, id_encuesta: @encuestum.id_encuesta, motivo_encuesta: @encuestum.motivo_encuesta, resuelto_encuesta: @encuestum.resuelto_encuesta } }
