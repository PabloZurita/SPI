...
class IndicadoresacumuladosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create indicadoresacumulado" do
    assert_difference('Indicadoresacumulado.count') do
      post indicadoresacumulados_url, params: { indicadoresacumulado: { fecha: @indicadoresacumulado.fecha, id_ind_acumulado: @indicadoresacumulado.id_ind_acumulado, isn: @indicadoresacumulado.isn, resp_1_2: @indicadoresacumulado.resp_1_2, resp_4_5: @indicadoresacumulado.resp_4_5 } }
    end
  ...
  test "should update indicadoresacumulado" do
    patch indicadoresacumulado_url(@indicadoresacumulado), params: { indicadoresacumulado: { fecha: @indicadoresacumulado.fecha, id_ind_acumulado: @indicadoresacumulado.id_ind_acumulado, isn: @indicadoresacumulado.isn, resp_1_2: @indicadoresacumulado.resp_1_2, resp_4_5: @indicadoresacumulado.resp_4_5 } }
